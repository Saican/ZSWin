...
class ZSWin_Terminal : ZSWindow
{
	...
	override void PostBeginPlay()
	{
		if (GetAge() < 1)
		{
			...
			Buttons.Push(new("ZButton").Init("testButton", "Click Me!" /*, Type:ZButton.standard*/, btn_xLocation:325, btn_yLocation:535, borderType:ZShape.thickbox, borderThickness:3));
		}
	}
