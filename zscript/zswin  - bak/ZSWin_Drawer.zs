	...
	*/
	ui static void WindowProcess_Background(ZSWindow nwd)
	{
		...
		if (nwd.BackgroundTexture.IsValid())
		{
			...
			// Stretch texture
			if (nwd.Stretch)
				Screen.DrawTexture(nwd.BackgroundTexture, nwd.Animate,
					nwdX, nwdY,
		...
		switch (nwd.BorderType)
		{
			...
			case nwd.ThickLine:
				...
				Screen.DrawThickLine(nwdX - nwd.BorderThickness, 
									nwdY - getLineThickness(nwd.BorderThickness), 
				...
				// Bottom
				Screen.DrawThickLine(nwdX - nwd.BorderThickness, 
									nwdY + realHeight + getLineThickness(nwd.BorderThickness, 0), 
									nwdX + realWidth + nwd.BorderThickness, 
									nwdY + realHeight + getLineThickness(nwd.BorderThickness, 0), 
									nwd.BorderThickness, 
									nwd.BorderColor, 
									int(255 * (nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha)));
				// Left
				Screen.DrawThickLine(nwdX - getLineThickness(nwd.BorderThickness, 0), 
									nwdY, 
									nwdX - getLineThickness(nwd.BorderThickness, 0), 
									nwdY + realHeight, 
									nwd.BorderThickness, 
									nwd.BorderColor, 
									int(255 * (nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha)));
				// Right
				Screen.DrawThickLine(nwdX + realWidth + getLineThickness(nwd.BorderThickness), 
									nwdY, 
									nwdX + realWidth + getLineThickness(nwd.BorderThickness), 
									nwdY + realHeight, 
									nwd.BorderThickness, 
									nwd.BorderColor, 
									int(255 * (nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha)));
			...
			case nwd.ZWin_Border:
				// Top Left Corner
				Screen.DrawTexture(nwd.gfxBorder.Corner_TopLeft, nwd.gfxBorder.Animate,
				...
				// Top Right Corner	
				Screen.DrawTexture(nwd.gfxBorder.Corner_TopRight, nwd.gfxBorder.Animate,
					nwdX + realWidth, 
					nwdY - nwd.gfxBorder.BorderHeight,
					DTA_Alpha, nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha,
					DTA_DestWidth, nwd.gfxBorder.BorderWidth,
					DTA_DestHeight, nwd.gfxBorder.BorderHeight);
				// Bottom Left Corner
				Screen.DrawTexture(nwd.gfxBorder.Corner_BottomLeft, nwd.gfxBorder.Animate,
					nwdX - nwd.gfxBorder.BorderWidth, 
					nwdY + realHeight,
					DTA_Alpha, nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha,
					DTA_DestWidth, nwd.gfxBorder.BorderWidth,
					DTA_DestHeight, nwd.gfxBorder.BorderHeight);
				// Bottom Right Corner	
				Screen.DrawTexture(nwd.gfxBorder.Corner_BottomRight, nwd.gfxBorder.Animate,
					nwdX + realWidth, 
					nwdY + realHeight,
					DTA_Alpha, nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha,
					DTA_DestWidth, nwd.gfxBorder.BorderWidth,
				...
				do
				{
					Screen.DrawTexture(nwd.gfxBorder.Side_Top, nwd.gfxBorder.Animate,
									nwdX + (nwd.gfxBorder.BorderWidth * w),
									nwdY - nwd.gfxBorder.BorderHeight,
									DTA_Alpha, nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha,
									DTA_DestWidth, nwd.gfxBorder.BorderWidth,
									DTA_DestHeight, nwd.gfxBorder.BorderHeight);
					Screen.DrawTexture(nwd.gfxBorder.Side_Bottom, nwd.gfxBorder.Animate,
									nwdX + (nwd.gfxBorder.BorderWidth * w),
									nwdY + realHeight,
									DTA_Alpha, nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha,
									DTA_DestWidth, nwd.gfxBorder.BorderWidth,
				...
				do
				{
					Screen.DrawTexture(nwd.gfxBorder.Side_Left, nwd.gfxBorder.Animate,
									nwdX - nwd.gfxBorder.BorderWidth,
									nwdY + (nwd.gfxBorder.BorderHeight * h),
									DTA_Alpha, nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha,
									DTA_DestWidth, nwd.gfxBorder.BorderWidth,
									DTA_DestHeight, nwd.gfxBorder.BorderHeight);
					Screen.DrawTexture(nwd.gfxBorder.Side_Right, nwd.gfxBorder.Animate,
									nwdX + realWidth,
									nwdY + (nwd.gfxBorder.BorderHeight * h),
									DTA_Alpha, nwd.GlobalEnabled ? nwd.BorderAlpha : nwd.GlobalAlpha,
									DTA_DestWidth, nwd.gfxBorder.BorderWidth,
				...
				switch (nwd.GetShape(i).Type)
				{
					...
					case ZShape.thickbox:
						...
						Screen.DrawThickLine((nwdX + nwd.GetShape(i).x_Start) - nwd.GetShape(i).LineThickness,
										(nwdY + nwd.GetShape(i).y_Start) - getLineThickness(nwd.GetShape(i).LineThickness),
						...
						// Bottom
						Screen.DrawThickLine((nwdX + nwd.GetShape(i).x_Start) - nwd.GetShape(i).LineThickness,
										(nwdY + nwd.GetShape(i).y_End) + getLineThickness(nwd.GetShape(i).LineThickness, 0),
										(nwdX + nwd.GetShape(i).x_End) + nwd.GetShape(i).LineThickness,
										(nwdY + nwd.GetShape(i).y_End) + getLineThickness(nwd.GetShape(i).LineThickness, 0),
										nwd.GetShape(i).LineThickness, 
										nwd.GetShape(i).Color,
										int((nwd.GlobalEnabled ? nwd.GetShape(i).Enabled ? nwd.GetShape(i).Alpha : 0.5 : nwd.GlobalAlpha) * 255));
						// Left
						Screen.DrawThickLine((nwdX + nwd.GetShape(i).x_Start) - getLineThickness(nwd.GetShape(i).LineThickness, 0),
										nwdY + nwd.GetShape(i).y_Start,
										(nwdX + nwd.GetShape(i).x_Start) - getLineThickness(nwd.GetShape(i).LineThickness, 0),
										nwdY + nwd.GetShape(i).y_End,
										nwd.GetShape(i).LineThickness,
										nwd.GetShape(i).Color,
										int((nwd.GlobalEnabled ? nwd.GetShape(i).Enabled ? nwd.GetShape(i).Alpha : 0.5 : nwd.GlobalAlpha) * 255));
						// Right
						Screen.DrawThickLine((nwdX + nwd.GetShape(i).x_End) + getLineThickness(nwd.GetShape(i).LineThickness),
										nwdY + nwd.GetShape(i).y_Start,
										(nwdX + nwd.GetShape(i).x_End) + getLineThickness(nwd.GetShape(i).LineThickness),
										nwdY + nwd.GetShape(i).y_End,
										nwd.GetShape(i).LineThickness,
										nwd.GetShape(i).Color,
										int((nwd.GlobalEnabled ? nwd.GetShape(i).Enabled ? nwd.GetShape(i).Alpha : 0.5 : nwd.GlobalAlpha) * 255));
